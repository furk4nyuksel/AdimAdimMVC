...
namespace MvcOrnek14PartitialViewKonusu
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual int kargoekkle(string kargoadi, string kargotel)
        {
            var kargoadiParameter = kargoadi != null ?
                new ObjectParameter("kargoadi", kargoadi) :
                new ObjectParameter("kargoadi", typeof(string));
    
            var kargotelParameter = kargotel != null ?
                new ObjectParameter("kargotel", kargotel) :
                new ObjectParameter("kargotel", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("kargoekkle", kargoadiParameter, kargotelParameter);
        }
    
        public virtual int kargoekle(string kargoadi, string kargotel)
        {
            var kargoadiParameter = kargoadi != null ?
                new ObjectParameter("kargoadi", kargoadi) :
                new ObjectParameter("kargoadi", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("kargoekle", kargoadiParameter, kargotelParameter);
        }
        ...
        public virtual ObjectResult<string> Urunarama(string param)
        {
            var paramParameter = param != null ?
                new ObjectParameter("param", param) :
                new ObjectParameter("param", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Urunarama", paramParameter);
        }
    }
}
